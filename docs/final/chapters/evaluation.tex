...
\begin{figure}[!h]
            \hfill
            \subfloat{\includegraphics[width=.45\textwidth]{images/metrics/conv_mean.png}}\hfill
            \subfloat{\includegraphics[width=.45\textwidth]{images/metrics/period_mean.png}}\hfill
            \newline
            \subfloat{\includegraphics[width=.45\textwidth]{images/metrics/volatility.png}}\hfill
            \subfloat{\includegraphics[width=.45\textwidth]{images/metrics/density.png}}\hfill
            \hfill
