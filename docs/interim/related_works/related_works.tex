...
\State{Mutations: Copy 30 selected candidates and mutate their weights and biases}
\State{Recombinations: Copy 40 pairs of selected candidates with replacement and apply crossover}
...
\begin{figure}[htp] 
    ...
    \subfloat[Attempt at learning cow and zebra skin patterns over 300 generations \cite{elmenreich2011evolving}]{%
        \includegraphics[width=0.45\textwidth]{related_works/animal-patterns.png}%
    ...
    \subfloat[Attempt at learning the Mona Lisa over 500 generations. Depicted from left to right are the original, the reference, and the best reproduction attempt \cite{elmenreich2011evolving}]{%
        \includegraphics[width=0.45\textwidth]{related_works/mona-lisa.png}%
        \label{fig:mona-lisa}%
        }%
...
In order to further improve the model, it would be useful to include a bias against complexity in the topology of the CPPNs.
